  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Monitor system health and operational performance</p>
      </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">Monitor processing times and efficiency</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <AlertCircle className="w-6 h-6 text-amber-600 mb-2" />
              <h3 className="font-medium text-gray-900">System Alerts</h3>
              <p className="text-sm text-gray-600">Track system issues and warnings</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <TrendingUp className="w-6 h-6 text-amber-600 mb-2" />
              <h3 className="font-medium text-gray-900">Health Trends</h3>
              <p className="text-sm text-gray-600">Analyze system performance over time</p>
            </div>
          </div>
        </div>
      </div>
