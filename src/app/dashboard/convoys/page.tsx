    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage convoy operations and multi-vehicle coordination
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            This page will handle convoy planning, vehicle coordination, and
            group transportation operations.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Plan and organize convoy groups
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Manage convoy security and safety
              </p>
            </div>
          </div>
        </div>
