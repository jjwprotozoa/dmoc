// src/app/dashboard/clients/table-view/page.tsx
'use client';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Clients (Table View)</h1>
          ...
          <a
            ...
            className="px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded-full hover:bg-blue-200 transition-colors whitespace-nowrap"
          >
            Back to Clients
          </a>
        </div>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          <button className="px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-2">
            ...
            {selectedClients.length > 0 && (
              <button className="px-4 py-2 bg-blue-100 text-blue-800 rounded-lg hover:bg-blue-200 transition-colors flex items-center justify-center space-x-2">
