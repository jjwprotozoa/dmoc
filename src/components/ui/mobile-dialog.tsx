    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'fixed inset-x-4 top-[50%] z-50 grid w-auto max-h-[85vh] translate-y-[-50%] gap-4 border bg-background p-4 shadow-lg duration-200',
          // Small screens: Keep mobile layout but allow more height
          'xs:max-h-[90vh]',
