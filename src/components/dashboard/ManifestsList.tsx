...
export function ManifestsList({ manifests, selectedManifest, onSelectManifest }: ManifestsListProps) {
  return (
              ...
              return (
                <div
                  ...
                  className={`p-4 cursor-pointer hover:bg-gray-50 ${
                    selectedManifest === manifest.id ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
                  onClick={() => onSelectManifest(manifest.id)}
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="font-medium text-gray-900">{manifest.title}</h3>
